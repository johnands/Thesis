...
can lead to numerical instability. The symmetry function will not able to identify distinct structures properly. 
This can be avoided by analyzing the distribution of values of each symmetry function on the data set. If the difference 
between the maximum and the minimum function value is too small, the symmetry function should be removed or its parameters changed.
