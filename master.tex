...
\textit{Universal approximation theorem} \cite{Hornik89}, a FFNN with just a single hidden layer containing 
...
In other words, adding complicating factors like cyclic or local connectivity is unnecessary for our purposes. 
