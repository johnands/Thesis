...
\begin{abstract}
 ...
 for sampling atomic configurations and energies, and TensorFlow, in combination with the Behler-Parinello method, 
 is employed to perform the fits. Further, we add a custom potential to LAMMPS that apply trained neural networks in simulations. 
...
\begin{table} 
  \begin{center}
    \begin{tabular*}{10cm}{l @{\extracolsep{\fill}} lll}
      ...
      \hline
      Bulk modulus    & 103.0  & 101.4  & 97.6 \\
      Shear modulus 1 & 53.63  & 56.45  & 1 \\
      Shear modulus 2 & 34.74  & 37.50  & 1 \\
      Poisson ratio   & 0.3484 & 0.3354 & 10 \\
      \bottomrule
      \end{tabular*} 
    \end{center}
    \captionsetup{width=12cm}
...
\bibitem{Zener48}
 ...
 In: \textit{Physical review} 74. (1948). 
