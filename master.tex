...
has later been refined by others. The brain contains billions of interconnected neurons that interact with their
neighbours by sending electrical signals to each other. If the sum of the input signals into one neuron surpasses
a certain threshold, it is \textit{activated}, and wil

An artificial neural network consists of layers of connected nodes, or neurons. 
