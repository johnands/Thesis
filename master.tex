...
consisting of three atoms of the same element with positions $\vec{r}_i$ where $i = 0,1,2$, shown in Figure (LAG FIGUR!!). 
...
like the NN potentials employed in this thesis: The force acting on an atom depends on the postions of the atoms as 
far as $2R_c$ away because we differentiate the energies of all neighbouring atoms, which in turn depend on \textit{their}
neighbours. 
