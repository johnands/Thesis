...
enable us to calculate the derivatives above. 
WRITE ABOUT THAT THIS IS VALID ALSO SEPERATELY VALID FOR G4 AND G5, AKA. TRIPLETS:
\begin{equation}
 \frac{\partial G^n(x_{ij}, x_{ik})}{\partial x_i} = -\frac{\partial G^n(x_{ij}, x_{ik})}{\partial x_{ij}} - 
 \frac{\partial G^n(x_{ij}, x_{ik})}{\partial x_{ik}}
\end{equation}
and 
\begin{subequations}
\begin{align}
...
\end{align}
\end{subequations}
i.e. the derivative w.r.t. $i$ is the negative sum of the derivatives w.r.t. $j$ and $k$. This is a symmetry that we
have exploited in our code. MAYBE SHOW THIS FOR THE SPECIFIC SYMMETRY FUNCTIONS, BUT THIS SHOULD BE 
A MORE GENERAL SYMMETRY THAT NOT ONLY IS DUE TO THEIR FUNCTIONAL FORM?
