...
deep neural networks research, but the software is also
applicable in a wide variety of other domains
as well (which ones?). 

SAY SOMETHING ABOUT WHAT THIS CHAPTER CONSIST OF

SECTION ON BASICS OF CONSTRUCTING A GRAPH
WITH EXAMPLE SCRIPT

TENSORBOARD VISUALIZATON

DIFFERENT FEATURES OF TENSORFLOW
