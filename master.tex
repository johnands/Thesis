...
\begin{equation}
 \tau = 
\begin{cases}
\textrm{trunc}\left[\alpha/a_{\textrm{max}}\right]\Delta t, 
&\textrm{if trunc}\left[\alpha/a_{\textrm{max}}\right] > 0 \\
\textrm{trunc}\left[\alpha/a_{\textrm{max}}\right]\Delta t + \Delta t, 
&\textrm{if trunc}\left[\alpha/a_{\textrm{max}}\right] = 0
\end{cases}
\label{variableIntervalSampling}
\end{equation}
where $a_i$ is the absolute value of the acceleration of atom $i$
