...
which is defined as the gradient of the NN. This gradient is given by the architecture of the NN, 
including the values of the weights and biases.
...
The derivatives of the Behler symmetry functions given in section \ref{sec:symmetryFunctions} are listed in \ref{app:appendixA1}. 
Since all these functions
