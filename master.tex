...
The author have previously written a basic molecular dynamics code, which has been employed to do some preliminary testing on 
...
The focus has been on model development, and writing our own code from scratch would have been 
Writing own code from scratch would have been too time-consuming, and left no time for 
We quickly decided that writing our own neural network library would be a complete thesis in itself, 
