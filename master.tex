...
\chapter{Constructing a neural network potential} \label{sec:trainingProcedure}
...
In this thesis we have mainly employed $G^2$ as the radial symmetry function and $G^5$ as the angular counterpart. 
Therefore, we only discuss these two functions in the following. 
...
\end{figure}
A set of initial angular symmetry functions can be made in a similar way. To probe different angles we vary 
$\zeta$ and $\lambda$. These angles can be probed at different radii, by adjusting either $\eta$ or $R_c$. 
...
should increase exponentially to ensure that the symmetry functions are sufficiently dissimilar. 



Thus, 1. and 2. can be used as a framework for constructing an initial 
