...
We have chosen to use the Behler-Parrinello (BP) method in this thesis, and this will be the topic of the 
rest of the chapter. 

\section{The Behler-Parrinello method}
In the Behler-Parrinello (BP) method, the architecture of each NN is fixed, and
...
\subsection{Transfer neural network from Python to C\texttt{++}}
...
\begin{subfigure}
  ...
  \caption{Error of the gradient of a NN trained to reproduce the shifted Lennard-Jones potential.
	   The NN is trained in Python and evaluated and differentiated in C\texttt{++} using the backpropagation algorithm.
